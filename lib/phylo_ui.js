...
// --- ツールチップ機能 (ガイドライン第6項④ 準拠) ---
    ...
    // ==========================================
    // 同一セッション内ステート保持＆完全スナップショット復元規格 (第7.4項準拠)
    // ==========================================
    ...
    function savePhyloWorkspace() {
        ...
        // 【安全弁】完成データが存在する場合、初期化時（isResetting）以外は未完了データによる上書き破壊を物理遮断
    ...
    function restorePhyloWorkspace() {
        ...
        try {
            ...
            if (data.hasCalculated) {
                ...
                // 系統樹Canvasの画像スナップショット復元（最速・確実に見た目を再現）
            ...
            // ★自爆シーケンス撤廃: エラーが起きても sessionStorage.removeItem は絶対に呼ばない
